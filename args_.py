...
def arg_init(args):
    ...
    args.add_argument("--model", type=str,
                    default="/cs2_yolov10s.pt", help="model path")
    args.add_argument("--end2end", type=bool,
                    default=False, help="use TensorRT efficientNMSPlugin")
    # Updated class argument to focus on CT_head and T_head (classes 1 and 2, for example)
    args.add_argument("--classes", type=int,
                      default=[1,2], help="classes to be detected. Change accordingly if your dataset uses different indexes for 'CT_head' and 'T_head'.")
