...
current_labels = []
image_copy = None
class_names = {0: "CT", 1: "CT_head", 2: "T", 3: "T_head"}
...
image_folder = 'dataSet/cs/train/images'  # Путь к папке с изображениями
label_folder = 'dataSet/cs/train/labels'  # Путь к папке с метками
